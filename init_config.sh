...
wget https://www.desy.de/~crpropa/data/magnetic_lenses/JF12full.tgz -P $SCRIPT_DIR/fancy/propagation/gmf_lens
tar -xvf $SCRIPT_DIR/fancy/propagation/gmf_lens/JF12full.tgz -C $SCRIPT_DIR/fancy/propagation/gmf_lens
rm $SCRIPT_DIR/fancy/propagation/gmf_lens/JF12full.tgz
printf "Done."
